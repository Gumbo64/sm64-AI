...
class SM64_ENV_TAG(SM64_ENV):
    def __init__(self, FRAME_SKIP=4, MAKE_OTHER_PLAYERS_INVISIBLE=True, PLAYER_COLLISION_TYPE=0, AUTO_RESET=False, N_RENDER_COLUMNS=2, render_mode="forced", HIDE_AND_SEEK_MODE=True, IMG_WIDTH=128, IMG_HEIGHT=72, ACTION_BOOK=[]):
        # placeholder
