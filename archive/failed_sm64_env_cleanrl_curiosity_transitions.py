...
if __name__ == "__main__":
    ...
    run_name = f"CURIOSITY_T_LSTMPPO_{int(time.time())}__LENGTH_{args.num_steps}_ACTIONS_{env.N_ACTIONS}_{env.IMG_WIDTH}x{env.IMG_HEIGHT}_PLAYERS_{env.MAX_PLAYERS}"
